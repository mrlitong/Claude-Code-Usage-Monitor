...
def get_theme(theme_name: Optional[str] = None) -> ThemeConfig:
    """Get theme configuration by name.

    Args:
        theme_name: Theme name (light, dark, classic) or None for auto-detect
    ...
    if theme_name is None:
        ...
        bg_type = detector.detect_background()
        if bg_type == BackgroundType.LIGHT:
            theme_name = "light"
        else:
            theme_name = "dark"

    return manager.get_theme(theme_name)
